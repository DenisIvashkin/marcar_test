      ...
      <div className="relative">
        ...
        {isOpen && (
          ...
          >
            <ul className="py-1">
              <li>
                <SortingButton handleSortChange={handleSortChange} order={order} type={'asc'} />
              </li>
              <li>
                <SortingButton handleSortChange={handleSortChange} order={order} type={'desc'} />
              </li>
              <li>
                <SortingButton handleSortChange={handleSortChange} order={order} type={''} />
              </li>
            </ul>
          </div>
        )}
